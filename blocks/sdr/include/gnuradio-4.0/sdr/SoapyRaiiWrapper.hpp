...
// using that device has finished configuring it. Registration owns a block's pending-user slot and
// its queued activation callback, and releases both when it is destroyed.
