// GENERATED FILE — do not edit. Source of truth: blocks/recipes/DbpskDemod.yaml.
// Regenerate with gr4-recipe-gen; qa_Recipes diffs this file against a fresh emission.
#ifndef GNURADIO_RECIPES_DBPSKDEMOD_HPP
#define GNURADIO_RECIPES_DBPSKDEMOD_HPP
...
struct DbpskDemod {
    ...
    [[nodiscard]] static const gr::detail::YamlDefinitionsLoader::Definition& definition() {
        static const gr::detail::YamlDefinitionsLoader::Definition kDefinition = [] {
            ...
            def.metadata.block_type = "gr::recipes::DbpskDemod";
            ...
            gr::pmt::Value e24;
            gr::property_map m25;
            m25[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("target output level of the front end's AGC, in decibels"));
            ...
            gr::property_map m30;
            m30[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("dbpsk_demod"));
            ...
            gr::pmt::Value e72;
            e72 = gr::pmt::Value(std::pmr::string("timing"));
            t71.push_back(std::move(e72));
            gr::pmt::Value e73;
            e73 = gr::pmt::Value(std::int64_t{0});
            t71.push_back(std::move(e73));
            gr::pmt::Value e74;
            e74 = gr::pmt::Value(std::pmr::string("phasor"));
            t71.push_back(std::move(e74));
            gr::pmt::Value e75;
            e75 = gr::pmt::Value(std::int64_t{0});
            t71.push_back(std::move(e75));
            e70 = gr::pmt::Value(std::move(t71));
            t45.push_back(std::move(e70));
            gr::pmt::Value e76;
            gr::Tensor<gr::pmt::Value> t77;
            gr::pmt::Value e78;
            e78 = gr::pmt::Value(std::pmr::string("phasor"));
            t77.push_back(std::move(e78));
            gr::pmt::Value e79;
            e79 = gr::pmt::Value(std::int64_t{0});
            t77.push_back(std::move(e79));
            gr::pmt::Value e80;
            e80 = gr::pmt::Value(std::pmr::string("decision"));
            t77.push_back(std::move(e80));
            gr::pmt::Value e81;
            e81 = gr::pmt::Value(std::int64_t{0});
            t77.push_back(std::move(e81));
            e76 = gr::pmt::Value(std::move(t77));
            t45.push_back(std::move(e76));
            m31[std::pmr::string("connections")] = gr::pmt::Value(std::move(t45));
            gr::Tensor<gr::pmt::Value> t82;
            gr::pmt::Value e83;
            gr::property_map m84;
            gr::property_map m85;
            m85[std::pmr::string("frequency_shift")] = gr::pmt::Value(std::pmr::string("=-frequency_offset"));
            m85[std::pmr::string("sample_rate")] = gr::pmt::Value(std::pmr::string("=sample_rate"));
            m85[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("translate"));
            m84[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m85));
            m84[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::math::Rotator<complex<float32>>"));
            e83 = gr::pmt::Value(std::move(m84));
            t82.push_back(std::move(e83));
            gr::pmt::Value e86;
            gr::property_map m87;
            gr::property_map m88;
            m88[std::pmr::string("decimation")] = gr::pmt::Value(std::pmr::string("=decimation"));
            m88[std::pmr::string("transition_width")] = gr::pmt::Value(std::pmr::string("=0.5 * channel_bandwidth * symbol_rate"));
            m88[std::pmr::string("profile")] = gr::pmt::Value(std::pmr::string("lowpass"));
            m88[std::pmr::string("cutoff")] = gr::pmt::Value(std::pmr::string("=channel_bandwidth * symbol_rate"));
            m88[std::pmr::string("sample_rate")] = gr::pmt::Value(std::pmr::string("=sample_rate"));
            m88[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("channel"));
            m87[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m88));
            m87[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::filter::DesignedFilter<complex<float32>, float32>"));
            e86 = gr::pmt::Value(std::move(m87));
            t82.push_back(std::move(e86));
            gr::pmt::Value e89;
            gr::property_map m90;
            gr::property_map m91;
            m91[std::pmr::string("attack_s")] = gr::pmt::Value(std::pmr::string("=agc_attack_symbols / symbol_rate"));
            m91[std::pmr::string("reference_db")] = gr::pmt::Value(std::pmr::string("=agc_reference_db"));
            m91[std::pmr::string("decay_s")] = gr::pmt::Value(std::pmr::string("=agc_decay_symbols / symbol_rate"));
            m91[std::pmr::string("sample_rate")] = gr::pmt::Value(std::pmr::string("=sample_rate / decimation"));
            m91[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("agc"));
            m90[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m91));
            m90[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::analog::Agc<complex<float32>>"));
            e89 = gr::pmt::Value(std::move(m90));
            t82.push_back(std::move(e89));
            gr::pmt::Value e92;
            gr::property_map m93;
            gr::property_map m94;
            m94[std::pmr::string("noise_bandwidth")] = gr::pmt::Value(std::pmr::string("=fll_noise_bandwidth"));
            m94[std::pmr::string("rolloff")] = gr::pmt::Value(std::pmr::string("=rolloff"));
            m94[std::pmr::string("samples_per_symbol")] = gr::pmt::Value(std::pmr::string("=sample_rate / (decimation * symbol_rate)"));
            m94[std::pmr::string("filter_length")] = gr::pmt::Value(std::pmr::string("=fll_filter_length"));
            m94[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("fll"));
            m93[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m94));
            m93[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::sync::FllBandEdge"));
            e92 = gr::pmt::Value(std::move(m93));
            t82.push_back(std::move(e92));
            gr::pmt::Value e95;
            gr::property_map m96;
            gr::property_map m97;
            m97[std::pmr::string("noise_bandwidth")] = gr::pmt::Value(std::pmr::string("=timing_noise_bandwidth"));
            m97[std::pmr::string("rolloff")] = gr::pmt::Value(std::pmr::string("=rolloff"));
            m97[std::pmr::string("samples_per_symbol")] = gr::pmt::Value(std::pmr::string("=sample_rate / (decimation * symbol_rate)"));
            m97[std::pmr::string("constellation")] = gr::pmt::Value(std::pmr::string("bpsk"));
            m97[std::pmr::string("detector")] = gr::pmt::Value(std::pmr::string("=timing_detector"));
            m97[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("timing"));
            m96[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m97));
            m96[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::sync::SymbolSync<complex<float32>>"));
            e95 = gr::pmt::Value(std::move(m96));
            t82.push_back(std::move(e95));
            gr::pmt::Value e98;
            gr::property_map m99;
            gr::property_map m100;
            m100[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("phasor"));
            m99[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m100));
            m99[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::digital::DifferentialPhasor<float32>"));
            e98 = gr::pmt::Value(std::move(m99));
            t82.push_back(std::move(e98));
            gr::pmt::Value e101;
            gr::property_map m102;
            gr::property_map m103;
            m103[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("decision"));
            m102[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m103));
            m102[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::basic::Real<complex<float32>>"));
            e101 = gr::pmt::Value(std::move(m102));
            t82.push_back(std::move(e101));
            m31[std::pmr::string("blocks")] = gr::pmt::Value(std::move(t82));
            ...
            m104[std::pmr::string("plugin_version")] = gr::pmt::Value(std::pmr::string("2026-09-02"));
            m104[std::pmr::string("plugin_license")] = gr::pmt::Value(std::pmr::string("MIT"));
            m104[std::pmr::string("plugin_author")] = gr::pmt::Value(std::pmr::string("gnuradio4 recipes"));
            m104[std::pmr::string("plugin_name")] = gr::pmt::Value(std::pmr::string("GrRecipes"));
            m104[std::pmr::string("block_type")] = gr::pmt::Value(std::pmr::string("gr::recipes::DbpskDemod"));
            def.definition[std::pmr::string("definition_metadata")] = gr::pmt::Value(std::move(m104));
            return def;
        }();
        return kDefinition;
    }
...
#endif // GNURADIO_RECIPES_DBPSKDEMOD_HPP
