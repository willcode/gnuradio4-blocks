// GENERATED FILE — do not edit. Source of truth: blocks/recipes/BpskFrontEnd.yaml.
// Regenerate with gr4-recipe-gen; qa_Recipes diffs this file against a fresh emission.
#ifndef GNURADIO_RECIPES_BPSKFRONTEND_HPP
#define GNURADIO_RECIPES_BPSKFRONTEND_HPP
...
struct BpskFrontEnd {
    struct Parameters {
        ...
        double frequency_offset = 0.0; // where the carrier sits relative to the front end's center, in hertz; 0 leaves the tuner inert
        ...
        double channel_bandwidth = 0.75; // cutoff of the channel filter as a multiple of the symbol rate; (1 + rolloff)/2 plus room for the transition band
    ...
    [[nodiscard]] static const gr::detail::YamlDefinitionsLoader::Definition& definition() {
        static const gr::detail::YamlDefinitionsLoader::Definition kDefinition = [] {
            ...
            def.metadata.block_type = "gr::recipes::BpskFrontEnd";
            ...
            gr::pmt::Value e8;
            gr::property_map m9;
            m9[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("where the carrier sits relative to the front end's center, in hertz; 0 leaves the tuner inert"));
            ...
            gr::pmt::Value e12;
            gr::property_map m13;
            m13[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("cutoff of the channel filter as a multiple of the symbol rate; (1 + rolloff)/2 plus room for the transition band"));
            ...
            gr::pmt::Value e14;
            gr::property_map m15;
            m15[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("excess bandwidth of the transmit shaping filter, in [0, 1]; the matched filter and the band-edge filter are both designed from it"));
            ...
            gr::pmt::Value e18;
            gr::property_map m19;
            m19[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("taps in each band-edge filter; 30 to 70 is the useful range"));
            ...
            gr::pmt::Value e24;
            gr::property_map m25;
            m25[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("target output level; 0 dB because the loops downstream state their detector gains at unit amplitude"));
            m25[std::pmr::string("default")] = gr::pmt::Value(0.0);
            m25[std::pmr::string("type")] = gr::pmt::Value(std::pmr::string("float64"));
            m25[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("agc_reference_db"));
            e24 = gr::pmt::Value(std::move(m25));
            t3.push_back(std::move(e24));
            gr::pmt::Value e26;
            gr::property_map m27;
            m27[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("gain-control time constant when the gain must decrease, in SYMBOL PERIODS; the recipe divides by symbol_rate, because a gain loop reading the instantaneous magnitude follows the modulation's own envelope unless its constant is long against a symbol"));
            m27[std::pmr::string("default")] = gr::pmt::Value(256.0);
            m27[std::pmr::string("type")] = gr::pmt::Value(std::pmr::string("float64"));
            m27[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("agc_attack_symbols"));
            e26 = gr::pmt::Value(std::move(m27));
            t3.push_back(std::move(e26));
            gr::pmt::Value e28;
            gr::property_map m29;
            m29[std::pmr::string("doc")] = gr::pmt::Value(std::pmr::string("gain-control time constant when the gain must increase, in SYMBOL PERIODS; twice the attack, so a level that rises is followed half as fast as one that falls"));
            m29[std::pmr::string("default")] = gr::pmt::Value(512.0);
            m29[std::pmr::string("type")] = gr::pmt::Value(std::pmr::string("float64"));
            m29[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("agc_decay_symbols"));
            e28 = gr::pmt::Value(std::move(m29));
            t3.push_back(std::move(e28));
            m2[std::pmr::string("exported_parameters")] = gr::pmt::Value(std::move(t3));
            gr::property_map m30;
            m30[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("bpsk_front_end"));
            m2[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m30));
            gr::property_map m31;
            gr::Tensor<gr::pmt::Value> t32;
            gr::pmt::Value e33;
            gr::Tensor<gr::pmt::Value> t34;
            gr::pmt::Value e35;
            e35 = gr::pmt::Value(std::pmr::string("translate"));
            t34.push_back(std::move(e35));
            gr::pmt::Value e36;
            e36 = gr::pmt::Value(std::pmr::string("INPUT"));
            t34.push_back(std::move(e36));
            gr::pmt::Value e37;
            e37 = gr::pmt::Value(std::pmr::string("in"));
            t34.push_back(std::move(e37));
            gr::pmt::Value e38;
            e38 = gr::pmt::Value(std::pmr::string("in"));
            ...
            gr::pmt::Value e54;
            e54 = gr::pmt::Value(std::pmr::string("channel"));
            t53.push_back(std::move(e54));
            gr::pmt::Value e55;
            e55 = gr::pmt::Value(std::int64_t{0});
            t53.push_back(std::move(e55));
            gr::pmt::Value e56;
            e56 = gr::pmt::Value(std::pmr::string("agc"));
            t53.push_back(std::move(e56));
            gr::pmt::Value e57;
            e57 = gr::pmt::Value(std::int64_t{0});
            t53.push_back(std::move(e57));
            e52 = gr::pmt::Value(std::move(t53));
            t45.push_back(std::move(e52));
            gr::pmt::Value e58;
            gr::Tensor<gr::pmt::Value> t59;
            gr::pmt::Value e60;
            e60 = gr::pmt::Value(std::pmr::string("agc"));
            t59.push_back(std::move(e60));
            gr::pmt::Value e61;
            e61 = gr::pmt::Value(std::int64_t{0});
            t59.push_back(std::move(e61));
            gr::pmt::Value e62;
            e62 = gr::pmt::Value(std::pmr::string("fll"));
            t59.push_back(std::move(e62));
            gr::pmt::Value e63;
            e63 = gr::pmt::Value(std::int64_t{0});
            t59.push_back(std::move(e63));
            e58 = gr::pmt::Value(std::move(t59));
            t45.push_back(std::move(e58));
            gr::pmt::Value e64;
            gr::Tensor<gr::pmt::Value> t65;
            gr::pmt::Value e66;
            e66 = gr::pmt::Value(std::pmr::string("fll"));
            t65.push_back(std::move(e66));
            gr::pmt::Value e67;
            e67 = gr::pmt::Value(std::int64_t{0});
            t65.push_back(std::move(e67));
            gr::pmt::Value e68;
            e68 = gr::pmt::Value(std::pmr::string("timing"));
            t65.push_back(std::move(e68));
            gr::pmt::Value e69;
            e69 = gr::pmt::Value(std::int64_t{0});
            t65.push_back(std::move(e69));
            e64 = gr::pmt::Value(std::move(t65));
            t45.push_back(std::move(e64));
            m31[std::pmr::string("connections")] = gr::pmt::Value(std::move(t45));
            gr::Tensor<gr::pmt::Value> t70;
            gr::pmt::Value e71;
            gr::property_map m72;
            gr::property_map m73;
            m73[std::pmr::string("frequency_shift")] = gr::pmt::Value(std::pmr::string("=-frequency_offset"));
            m73[std::pmr::string("sample_rate")] = gr::pmt::Value(std::pmr::string("=sample_rate"));
            m73[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("translate"));
            m72[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m73));
            m72[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::math::Rotator<complex<float32>>"));
            e71 = gr::pmt::Value(std::move(m72));
            t70.push_back(std::move(e71));
            gr::pmt::Value e74;
            gr::property_map m75;
            gr::property_map m76;
            m76[std::pmr::string("decimation")] = gr::pmt::Value(std::pmr::string("=decimation"));
            m76[std::pmr::string("transition_width")] = gr::pmt::Value(std::pmr::string("=0.5 * channel_bandwidth * symbol_rate"));
            m76[std::pmr::string("profile")] = gr::pmt::Value(std::pmr::string("lowpass"));
            m76[std::pmr::string("cutoff")] = gr::pmt::Value(std::pmr::string("=channel_bandwidth * symbol_rate"));
            m76[std::pmr::string("sample_rate")] = gr::pmt::Value(std::pmr::string("=sample_rate"));
            m76[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("channel"));
            m75[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m76));
            m75[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::filter::DesignedFilter<complex<float32>, float32>"));
            e74 = gr::pmt::Value(std::move(m75));
            t70.push_back(std::move(e74));
            gr::pmt::Value e77;
            gr::property_map m78;
            gr::property_map m79;
            m79[std::pmr::string("attack_s")] = gr::pmt::Value(std::pmr::string("=agc_attack_symbols / symbol_rate"));
            m79[std::pmr::string("reference_db")] = gr::pmt::Value(std::pmr::string("=agc_reference_db"));
            m79[std::pmr::string("decay_s")] = gr::pmt::Value(std::pmr::string("=agc_decay_symbols / symbol_rate"));
            m79[std::pmr::string("sample_rate")] = gr::pmt::Value(std::pmr::string("=sample_rate / decimation"));
            m79[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("agc"));
            m78[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m79));
            m78[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::analog::Agc<complex<float32>>"));
            e77 = gr::pmt::Value(std::move(m78));
            t70.push_back(std::move(e77));
            gr::pmt::Value e80;
            gr::property_map m81;
            gr::property_map m82;
            m82[std::pmr::string("noise_bandwidth")] = gr::pmt::Value(std::pmr::string("=fll_noise_bandwidth"));
            m82[std::pmr::string("rolloff")] = gr::pmt::Value(std::pmr::string("=rolloff"));
            m82[std::pmr::string("samples_per_symbol")] = gr::pmt::Value(std::pmr::string("=sample_rate / (decimation * symbol_rate)"));
            m82[std::pmr::string("filter_length")] = gr::pmt::Value(std::pmr::string("=fll_filter_length"));
            m82[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("fll"));
            m81[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m82));
            m81[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::sync::FllBandEdge"));
            e80 = gr::pmt::Value(std::move(m81));
            t70.push_back(std::move(e80));
            gr::pmt::Value e83;
            gr::property_map m84;
            gr::property_map m85;
            m85[std::pmr::string("noise_bandwidth")] = gr::pmt::Value(std::pmr::string("=timing_noise_bandwidth"));
            m85[std::pmr::string("rolloff")] = gr::pmt::Value(std::pmr::string("=rolloff"));
            m85[std::pmr::string("samples_per_symbol")] = gr::pmt::Value(std::pmr::string("=sample_rate / (decimation * symbol_rate)"));
            m85[std::pmr::string("constellation")] = gr::pmt::Value(std::pmr::string("bpsk"));
            m85[std::pmr::string("detector")] = gr::pmt::Value(std::pmr::string("=timing_detector"));
            m85[std::pmr::string("name")] = gr::pmt::Value(std::pmr::string("timing"));
            m84[std::pmr::string("parameters")] = gr::pmt::Value(std::move(m85));
            m84[std::pmr::string("id")] = gr::pmt::Value(std::pmr::string("gr::blocks::sync::SymbolSync<complex<float32>>"));
            e83 = gr::pmt::Value(std::move(m84));
            t70.push_back(std::move(e83));
            m31[std::pmr::string("blocks")] = gr::pmt::Value(std::move(t70));
            m2[std::pmr::string("graph")] = gr::pmt::Value(std::move(m31));
            ...
            gr::property_map m86;
            m86[std::pmr::string("plugin_version")] = gr::pmt::Value(std::pmr::string("2026-09-02"));
            m86[std::pmr::string("plugin_license")] = gr::pmt::Value(std::pmr::string("MIT"));
            m86[std::pmr::string("plugin_author")] = gr::pmt::Value(std::pmr::string("gnuradio4 recipes"));
            m86[std::pmr::string("plugin_name")] = gr::pmt::Value(std::pmr::string("GrRecipes"));
            m86[std::pmr::string("block_type")] = gr::pmt::Value(std::pmr::string("gr::recipes::BpskFrontEnd"));
            def.definition[std::pmr::string("definition_metadata")] = gr::pmt::Value(std::move(m86));
            return def;
        }();
        return kDefinition;
    }
...
#endif // GNURADIO_RECIPES_BPSKFRONTEND_HPP
