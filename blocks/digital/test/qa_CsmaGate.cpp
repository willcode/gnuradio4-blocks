...
const boost::ut::suite<"csma_gate"> csmaGateTests = [] {
    ...
    // The gate holds and releases on the sense state, exactly.
    ...
    // The gate reads only the newest sense item.
    ...
    // Identical output at input chunk sizes {1, 3, 4096}, run under the scheduler.
