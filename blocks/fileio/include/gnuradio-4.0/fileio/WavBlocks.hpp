...
private:
    // the cap counts the header it has to pay for; a freshly opened file always takes at least one
    // sample so a cap too small to hold one cannot rotate forever without making progress
