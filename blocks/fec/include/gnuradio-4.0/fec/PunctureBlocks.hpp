...
struct Puncture : Block<Puncture> {
    ...
    void stop() {
        ...
        detail::report("gr::blocks::fec::Puncture", this->name, counters);
    }
...
struct Depuncture : Block<Depuncture> {
    ...
    void stop() {
        ...
        detail::report("gr::blocks::fec::Depuncture", this->name, counters);
    }
